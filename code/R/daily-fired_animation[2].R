...
static <- ggplot() +
 ...
 geom_label(aes(x = Inf, y = Inf, label = fire_names[2]), 
            hjust = 2.75, vjust = 1.4, fill = alpha("black", 0.5), 
...
ggsave(static, file = "figures/animations/AugustComplex_static.png",
...
# Save GIF file.
anim_save("figures/animations/AugustComplex_animation.gif")
